...
const EcommerceChatbot = () => {
  ...
  const products: Product[] = [
    ...
    },
    {
      ...
      category: "Electronics",
      description:
        "Track your fitness goals with GPS, heart rate monitoring, and smartphone integration.",
    },
    {
      id: 3,
      ...
      category: "Clothing",
      description:
        "Comfortable, sustainable organic cotton t-shirt available in multiple colors.",
    },
    {
      id: 4,
